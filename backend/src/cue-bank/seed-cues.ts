...
export const SEED_CUES: Cue[] = [
  // ── Stage I · BASELINE (Anchor) — establish the fact of capability ─────────
  {
    ...
    PhysicalLever_Metal: 'Root through the floor',
    EnergeticVector_Water: 'Localize intention',
  ...
  },
  {
    CueID: 'baseline.drop',
    PrimaryState: S.BASELINE,
    PhysicalLever_Metal: 'Lower center of gravity',
    EnergeticVector_Water: 'Release secondary tension',
    StructuralYield_Wood: 'Absorb the load',
  ...
  },
  {
    ...
    PrimaryState: S.BASELINE,
    PhysicalLever_Metal: 'Extend spine',
    EnergeticVector_Water: 'Channel the breath',
    StructuralYield_Wood: 'Boundary expansion',
  ...
  },
  {
    ...
    PhysicalLever_Metal: 'Extend spine',
    EnergeticVector_Water: 'Release secondary tension',
    StructuralYield_Wood: 'Yield then hold',
  ...
  },
  {
    ...
    PrimaryState: S.GROWTH,
    PhysicalLever_Metal: 'Extend spine',
    EnergeticVector_Water: 'Flood the target',
    StructuralYield_Wood: 'Yield then hold',
